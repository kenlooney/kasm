...
- [0.2.0–0.4.0 — RET, Binary Output, and Generated Headers](./04-ret-binary-headers.md)
- [0.5.0–0.6.0 — Making It Actually Run](./05-execution.md)
- [0.7.0–0.9.0 — Labels, Layout, and Near Jumps](./06-labels-and-layout.md)
- [0.10.0–0.12.0 — Short Jumps, Relocation, and Absolute Jumps](./07-jumps-and-relocation.md)
- [0.14.0 — Conditional Branches and a Decoder](./08-control-flow.md)
- [0.15.0–0.20.0 — Growing the Arithmetic ISA](./09-arithmetic-isa.md)
- [0.19.1–0.22.0 — Hardening the Frontend](./10-hardening.md)
- [0.23.0–0.25.1 — Data Directives and Location-Aware Layout](./11-data-directives.md)
- [0.26.0–0.30.0 — The 16-Bit Adventures](./12-sixteen-bit.md)
