...
operands, and evaluates expressions. It encodes `mov eax, <expression>;` and
...
This milestone adds definitions only. Label address calculation, duplicate-name
checking, symbol references, and jumps are not implemented yet.
...
registers, label references and symbol resolution, memory operands, directives, and object
...
The label sample, C inspection, and Linux/Windows execution examples above are manual checks; they
