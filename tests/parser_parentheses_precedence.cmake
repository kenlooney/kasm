set(path "${CMAKE_CURRENT_BINARY_DIR}/parser-parentheses-precedence.asm")
...
# Expect (2+3)*4, with addition as the multiplication's left child.
string(REPLACE "\r\n" "\n" output "${output}")
string(CONCAT expected
    "node 0: kind=0 value=2 left=-1 right=-1\n"
    "node 1: kind=0 value=3 left=-1 right=-1\n"
    "node 2: kind=1 value=0 left=0 right=1\n"
    "node 3: kind=0 value=4 left=-1 right=-1\n"
    "node 4: kind=3 value=0 left=2 right=3\n"
    "root = 4\n")
